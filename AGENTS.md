...
# 🌌 ConStellaration Fusion Challenge: Unified Master Guideline
...
### 🐣 Problem 1: Geometrically Optimized Stellarator
...
### 🏗️ Problem 2: Simple-to-Build QI Stellarator
...
### 🦄 Problem 3: Multi-Objective, MHD-Stable QI Stellarator
...
- Target ≥80% branch coverage (`coverage run -m pytest && coverage report` when auditing).
