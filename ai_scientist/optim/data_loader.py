...
class LogRobustScaler(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, with_centering=True, with_scaling=True):
        ...
        self.robust_scaler = RobustScaler(with_centering=with_centering, with_scaling=with_scaling)
...
def load_constellaration_dataset(
    ...
    df.columns = [c.replace("metrics.", "") if c != "metrics.id" else c for c in df.columns]
