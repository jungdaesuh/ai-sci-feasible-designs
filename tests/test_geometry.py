...
def test_fourier_to_real_space_numpy():
    ...
    R, Z, Phi = geometry.fourier_to_real_space(r_cos, z_sin, n_theta=4, n_zeta=4, n_field_periods=1)
...
def test_fourier_to_real_space_torch():
    ...
    R, Z, Phi = geometry.fourier_to_real_space(r_cos, z_sin, n_theta=8, n_zeta=8, n_field_periods=1)
